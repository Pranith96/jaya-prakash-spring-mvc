...
<body bgcolor="#87ceff">
	...
	<h3 style="text-align: left;">User Details Update Form</h3>

	<table align="left">

		<form:form commandName="user" name="myform"
			action="../../communityportal/user/update/check" method="put"
			...
			<tr>
				...
				<td><form:input path="emailId" placeholder="Email Id cannot be updated. Enter Existing mail id"></form:input></td>
			</tr>
