...
<head>
<title>Community Portal Website</title>
...
<body>
	<nav class="navbar background">
		<ul class="nav-list">
			<li><a href="http://localhost:8080/communityportal/user/portal">
					Portal Details</a></li>
			<li><a
				href="http://localhost:8080/communityportal/user/get/profile/${userId}">Profile</a></li>
			<li><a
				href="http://localhost:8080/communityportal/user/get/allUsers">Get
					All Users List</a></li>
			<li><a
				href="http://localhost:8080/communityportal/user/password/check">Update
					Password</a></li>
			<li><a href="http://localhost:8080/communityportal/user/login">Logout</a></li>
		</ul>
		<div class="rightNav">
			<form:form commandName="user" action="../../user/search"
				method="get">
