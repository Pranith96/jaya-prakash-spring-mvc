...
<body>
	<nav class="navbar background">
		<ul class="nav-list">
			<li><a href="http://localhost:8080/communityportal/user/home">Home</a></li>
			<li><a
				href="http://localhost:8080/communityportal/user/register">Register</a></li>
			<li><a href="http://localhost:8080/communityportal/user/login">Login</a></li>
		</ul>
	</nav>
